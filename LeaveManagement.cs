...
namespace LeaveMangementForm
{
    public partial class LeaveManagement : Form
    {
        ...
        private void fileUpload_btn_Click(object sender, EventArgs e)
        {
            ...
            open_Att_File_dlg.Filter = "Select Valid Document(*.txt;*.pdf; *.doc; *.xlsx; *.html)|*.txt;*.pdf; *.docx; *.xlsx; *.html";
        ...
        public void SaveToMysql() 
        {
            ...
            byte[] rawData = File.ReadAllBytes(Attach_View_Fill_tbx.Text);
            ...
            try
            {
                using (MySqlConnection connection = new MySqlConnection(ConnectionString))
                {
                    using (MySqlCommand command = new MySqlCommand())
                    {
                        ...
                        MySqlParameter blobData = new MySqlParameter("?LE_Docs", MySqlDbType.Blob, rawData.Length);
